...
ADD services/migration_service/requirements.txt /root/services/migration_service/requirements.txt
ADD services/ui_backend_service/requirements.txt /root/services/ui_backend_service/requirements.txt
RUN pip3 install -r /root/services/migration_service/requirements.txt \
 && pip3 install -r /root/services/ui_backend_service/requirements.txt
...
WORKDIR /root
RUN /opt/latest/bin/pip install -e .
